  ...
  <d2-container>
    ...
    <el-table  v-loading="loading"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="top">
            <p>作者: {{ scope.row.xUser.uname }}</p>
            <div slot="reference" class="name-wrapper">
              <el-tag> <el-link :underline="false" :href="'http://127.0.0.1:8088/getShare/' + scope.row.sId" target="_blank" type="primary" size="medium">{{ scope.row.sTitle}}</el-link></el-tag>
            </div>
          </el-popover>
        </template>
      </el-table-column>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="top">
            <p>{{ scope.row.sType2 }}</p>
            <p>{{ scope.row.sType3 }}</p>
            <div slot="reference" class="name-wrapper">
              <span style="margin-left: 10px">{{ scope.row.sType1}}</span>
            </div>
          </el-popover>
        </template>
